...
public class MenusGame : MonoBehaviour {
	...
	void Start() {
		...
		if (PlayerPrefs.GetInt("numberOfGames") >= 10)
		{
			if (PlayerPrefs.GetInt("play10Games") != 1)
			{
				...
				GetComponent<AchievementUnlocked>().enabled = true;
				GetComponent<AchievementUnlocked>().NameOfTheAchievement("play 10 Games");
			}
		}
		if (PlayerPrefs.GetInt("numberOfGames") >= 100)
		{
			if (PlayerPrefs.GetInt("play100Games") != 1)
			{
				...
				GetComponent<AchievementUnlocked>().enabled = true;
				GetComponent<AchievementUnlocked>().NameOfTheAchievement("play 100 Games");
			}
		}
		if (PlayerPrefs.GetInt("numberOfGames") >= 1000)
		{
			if (PlayerPrefs.GetInt("play1000Games") != 1)
			{
				...
				GetComponent<AchievementUnlocked>().enabled = true;
				GetComponent<AchievementUnlocked>().NameOfTheAchievement("play 1000 Games");
			}
		}
	}
	...
	public void ShowGameoverMenu () {
		...
		GameObject.Find ("ballMain").GetComponent<MainBall> ().enabled = false;
